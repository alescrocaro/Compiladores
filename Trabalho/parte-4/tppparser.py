...
def main():
    ...
    try:
        ...
        if root and root.children != ():
            print("Gerando arvore sintatica...")
            ...
            print("Nao foi possível gerar a arvore sintatica.")
            
    
    except: 
        print('Nao foi possivel realizar a analise sintatica')
